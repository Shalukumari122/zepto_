...
df = pd.read_excel(excel_file,sheet_name='Sheet1')  # Adjust sheet name as necessary

# Iterate through each row in the DataFrame
for index, row in df.iterrows():
    # Vashi	402107	Mumbai
    # Palava	421204	Mumbai
    zipcode = '110095'
    city = 'New Delhi'
    area = 'Dilshad Garden'
    # zipcode = row['City']
    ...
    try:
        r1 = requests.get(
            f'https://api.zepto.co.in/api/v1/maps/place/autocomplete/?place_name={zipcode},+{area},+{city}').json()
